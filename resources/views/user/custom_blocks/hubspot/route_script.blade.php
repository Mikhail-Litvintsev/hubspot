<script>
    ...
    window.hubspot_contact_deal_store_url = "{{ route('user.integrations.blocks.hubspot.contact.deal.store') }}";
    window.hubspot_deal_settings_edit_url = "{{ route('user.integrations.blocks.hubspot.deal_settings.edit') }}";
    window.hubspot_deal_settings_update_url = "{{ route('user.integrations.blocks.hubspot.deal_settings.update') }}";
</script>